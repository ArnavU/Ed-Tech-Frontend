    ...
    <div className='' >
      <form className='mt-6 flex w-full flex-col gap-y-4'
        ...
        <div className='flex gap-x-1 bg-richblack-800 p-1 my-1 rounded-full max-w-max shadow-[0_1px_0] shadow-[rgba(255,255,255,0.3)]'>
          ...
          `}>
            <input type="radio" name='accountType' value={'Student'} className='appearance-none' onClick={handleOnChange} />
            Student
          </label>
          ...
          `}>
            <input type="radio" name='accountType' value={'Instructor'} className={`appearance-none`} onClick={handleOnChange} />
            Instructor
          </label>
